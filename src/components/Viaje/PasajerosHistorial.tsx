    ...
    <div className="container mt-4 mb-5 pb-5" style={{ maxWidth: '800px' }}>
      ...
      {viajeInfo && (
        ...
        >
          <div className="card-body p-4">
            ...
            <div
              className="d-flex text-muted gap-4 mt-2"
              style={{ fontSize: '0.95rem' }}
            >
              <span>
                <i className="bi bi-calendar3 me-2"></i>{' '}
                {viajeInfo.fecha.split('-').reverse().join('/')}
              </span>
              <span>
                <i className="bi bi-clock me-2"></i>{' '}
                {viajeInfo.horario.substring(0, 5)}
              </span>
            </div>
          </div>
        </div>
      ...
      {pasajeros.length === 0 ? (
        <div className="alert alert-light border">
          No hubo pasajeros aprobados en este viaje.
        </div>
      ) : (
        <div className="row">
              ...
              <div className="card shadow-sm border-0 rounded-4">
                <div className="card-body p-3 d-flex align-items-start justify-content-between">
                  <div className="d-flex align-items-start">
                    ...
                    >
                      {pasajero.nombre.charAt(0)}
                      {pasajero.apellido.charAt(0)}
                    </div>
                    <div>
                      ...
                      <h6
                        className="fw-bold text-dark mt-3 mb-1"
                  ...
                  <div className="text-end">
                    <span className="d-block text-muted small fw-semibold mb-1">
                      Tu calificación:
                    </span>
