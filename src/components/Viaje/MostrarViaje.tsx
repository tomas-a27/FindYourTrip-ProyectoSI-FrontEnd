                  ...
                  <div className="card-body p-2">
                        ...
                        <div className="position-relative me-3">
                          ...
                          >
                            <i className="bi bi-star">
                              {' '}
                              3.0{viaje.usuarioConductor.calificacionConductor}
                            </i>
                          </span>
                        </div>
                      ...
                      <div className="col-7 position-relative">
                        ...
                        >
                          <div className="position-relative">
                            <span
                              className="position-absolute start-0 top-50 translate-middle border border-secondary rounded-circle bg-white"
                              style={{
                                width: '8px',
                                height: '8px',
                                marginLeft: '-20px',
                    ...
                    <p className="text-muted small mb-4">
                      {viaje.viajeComentario ||
                        'Aquí se muestra la info adicional si el conductor agregó'}
                    </p>
