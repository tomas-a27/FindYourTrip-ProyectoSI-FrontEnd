...
export const InicioAdmin = () => {
  ...
  const opciones = [
    ...
    { titulo: 'Usuarios a sancionar (o en condición)', descripcion: 'Sección para gestionar a usuarios que han cometido multiples infracciones.', ruta: '/usuarios-a-sancionar' },
    { titulo: 'Listado de localidades', descripcion: 'Acceso a la base de datos de las localidades cubiertas por el servicio.', ruta: '/mostrar-localidad' },
    { titulo: 'Informe de conductores ordenados por calificación', descripcion: 'Muestra un listado basado en las calificaciones de los conductores.', ruta: '/informe-conductores' },
